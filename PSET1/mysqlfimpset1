...
CREATE USER 'vitorguimaraes'@'localhost' identified by '202203895'
GRANT ALL PRIVILEGES ON *.* TO 'vitorguimaraes'@'localhost';

mysql -u vitorguimaraes -p
202203895
...
ALTER TABLE cargos COMMENT 'mostra os cargos e os salarios.';

ALTER TABLE cargos MODIFY COLUMN id_cargo_ VARCHAR(10) COMMENT 'PK da tabela.';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Nome.';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'menor salário';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'maior salário.';
...
ALTER TABLE regioes COMMENT 'Tabela que contém o codigo e os nomes das regiões.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave primária da tabela regiões.';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Nomes';
...
ALTER TABLE paises COMMENT 'contem as infos dos países.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'PK dessa tabela';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'FK da tabela regioes';
...
ALTER TABLE localizacoes COMMENT 'Contém os endereços da empresa. Não armazena endereços de clientes.';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'PK dessa tabela';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereço de um escritório ou facilidade.';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(21) COMMENT 'CEP ou codigo postal';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade onde está localizado a empresa';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'abreviação do estado que a empresa se localiza.';

ALTER TABLE localizacoes MODIFY COLUMN id_pais_ CHAR(2) COMMENT 'FK da tabela paises';
...
ALTER TABLE departamentos COMMENT 'Tabela com expecificacoes sobre os departamentos da empresa.';

ALTER TABLE departamentos MODIFY COLUMN id_departamento_ INTEGER COMMENT 'PK da tabela.';

ALTER TABLE departamentos MODIFY COLUMN nome_ VARCHAR(50) COMMENT 'Nome do departamento.';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'o departamento';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'FK para a tabela de empregados.';
...
CREATE TABLE empregados (
                ...
                id_departamento__ INT,
                id_supervisor__ INT,
                PRIMARY KEY (id_empregado)
);

ALTER TABLE empregados COMMENT 'contem as informaçoes dos funcionarios';

ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'PK da tabela.';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'Nome completo dos funcionarios';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Parte inicial do email do empregado, mas sem colocar o @.';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Telefone do funcionario.';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data que o empregado entrou na empresa';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'FK para a tabela cargos. Indica o cargo do empregado.';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Salário do empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'vendas';

ALTER TABLE empregados MODIFY COLUMN id_departamento__ INTEGER COMMENT 'um empregado.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor__ INTEGER COMMENT 'Indica o supervisor do empregado.';
...
CREATE TABLE historico_cargos_ (
                ...
                id_departamento__ INT,
                PRIMARY KEY (id_empregado, data_inicial_)
);

ALTER TABLE historico_cargos_ COMMENT 'mostra os cargos antigos dos funcionarios';

ALTER TABLE historico_cargos_ MODIFY COLUMN id_empregado INTEGER COMMENT 'PK da tabela e tambem uma FK';

ALTER TABLE historico_cargos_ MODIFY COLUMN data_inicial_ DATE COMMENT 'ovo cargo. Deve ser menor do que a data_final.';

ALTER TABLE historico_cargos_ MODIFY COLUMN data_final DATE COMMENT 'que a data inicial.';

ALTER TABLE historico_cargos_ MODIFY COLUMN id_cargo__ VARCHAR(10) COMMENT 'do estava trabalhando no passado.';

ALTER TABLE historico_cargos_ MODIFY COLUMN id_departamento__ INTEGER COMMENT 'to que o empregado trabalhava no passado.';
